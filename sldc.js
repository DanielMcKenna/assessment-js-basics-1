...
let analysis = "Analysis of Requirements";
let planning = "Planning";
let design = "Design";
let implement = "Implementation/ software development";
let testing = "Testing what you build";
let maintain = "maintain what you built";
